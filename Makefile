...
install_sdks: install_dotnet_sdk install_go_sdk install_nodejs_sdk install_python_sdk install_java_sdk
...
help:
	...
	@echo ""
	@echo "  [language] = dotnet go nodejs python java"
	@echo ""
.PHONY: help
...
# `cmd/pulumi-resource-ovh/schema.json` is valid and up to date.
