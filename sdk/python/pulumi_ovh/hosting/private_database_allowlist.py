...
class PrivateDatabaseAllowlistArgs:
    def __init__(__self__, *,
                 ...
                 service: pulumi.Input[builtins.bool],
                 service_name: pulumi.Input[builtins.str],
                 sftp: pulumi.Input[builtins.bool],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PrivateDatabaseAllowlist resource.
        :param pulumi.Input[builtins.str] ip: The whitelisted IP in your instance.
        :param pulumi.Input[builtins.bool] service: Authorize this IP to access service port. Values can be `true` or `false`
        :param pulumi.Input[builtins.str] service_name: The internal name of your private database.
        :param pulumi.Input[builtins.bool] sftp: Authorize this IP to access SFTP port. Values can be `true` or `false`
        :param pulumi.Input[builtins.str] name: Custom name for your Whitelisted IP.
        """
    ...
    @property
    @pulumi.getter
    def service(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @service.setter
    def service(self, value: pulumi.Input[builtins.bool]):
    ...
    @property
    @pulumi.getter
    def sftp(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @sftp.setter
    def sftp(self, value: pulumi.Input[builtins.bool]):
...
class _PrivateDatabaseAllowlistState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 service: Optional[pulumi.Input[builtins.bool]] = None,
                 service_name: Optional[pulumi.Input[builtins.str]] = None,
                 sftp: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter
    def service(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Authorize this IP to access service port. Values can be `true` or `false`
        """
        return pulumi.get(self, "service")
    ...
    @service.setter
    def service(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "service", value)
    ...
    @property
    @pulumi.getter
    def sftp(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Authorize this IP to access SFTP port. Values can be `true` or `false`
        """
        return pulumi.get(self, "sftp")
    ...
    @sftp.setter
    def sftp(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sftp", value)
...
class PrivateDatabaseAllowlist(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service: Optional[pulumi.Input[builtins.bool]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            sftp: Optional[pulumi.Input[builtins.bool]] = None) -> 'PrivateDatabaseAllowlist':
        """
    ...
    @property
    @pulumi.getter
    def service(self) -> pulumi.Output[builtins.bool]:
        """
        Authorize this IP to access service port. Values can be `true` or `false`
        """
        return pulumi.get(self, "service")
    ...
    @property
    @pulumi.getter
    def sftp(self) -> pulumi.Output[builtins.bool]:
        """
        Authorize this IP to access SFTP port. Values can be `true` or `false`
        """
        return pulumi.get(self, "sftp")
