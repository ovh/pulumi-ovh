...
def get_private_database_user_grant(database_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_name: The database name on which grant the user
...
def get_private_database_user_grant_output(database_name: Optional[pulumi.Input[_builtins.str]] = None,
