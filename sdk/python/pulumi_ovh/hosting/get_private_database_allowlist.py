...
def get_private_database_allowlist(ip: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip: The whitelisted IP in your instance
...
def get_private_database_allowlist_output(ip: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
