...
class PrivateDatabaseUserGrantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_name: Database name where add grant.
        :param pulumi.Input[builtins.str] grant: Database name where add grant. Values can be:
               - admin
               - none
               - ro
               - rw
...
class _PrivateDatabaseUserGrantState:
    def __init__(__self__, *,
                 ...
                 grant: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def grant(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database name where add grant. Values can be:
        - admin
        - none
    ...
    @grant.setter
    def grant(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grant", value)
...
@pulumi.type_token("ovh:Hosting/privateDatabaseUserGrant:PrivateDatabaseUserGrant")
class PrivateDatabaseUserGrant(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            grant: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateDatabaseUserGrant':
        """
    ...
    @property
    @pulumi.getter
    def grant(self) -> pulumi.Output[builtins.str]:
        """
        Database name where add grant. Values can be:
        - admin
        - none
