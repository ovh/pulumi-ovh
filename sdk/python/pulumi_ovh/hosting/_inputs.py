...
class PrivateDatabaseOrderDetailArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] description: Custom description on your privatedatabase order.
...
class PrivateDatabasePlanOptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] duration: Service duration
        :param pulumi.Input[_builtins.str] plan_code: Plan code
        :param pulumi.Input[_builtins.str] pricing_mode: Pricing model identifier
        :param pulumi.Input[_builtins.str] catalog_name: Catalog name
