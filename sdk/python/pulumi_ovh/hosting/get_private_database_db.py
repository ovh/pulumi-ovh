...
def get_private_database_db(database_name: Optional[builtins.str] = None,
...
def get_private_database_db_output(database_name: Optional[pulumi.Input[builtins.str]] = None,
