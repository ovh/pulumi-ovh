...
class PrivateDatabaseUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] password: Password for the new user (alphanumeric, minimum one number and 8 characters minimum)
        :param pulumi.Input[_builtins.str] service_name: The internal name of your private database.
        :param pulumi.Input[_builtins.str] user_name: User name used to connect on your databases
        """
...
class PrivateDatabaseUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[_builtins.str]] = None,
            service_name: Optional[pulumi.Input[_builtins.str]] = None,
            user_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'PrivateDatabaseUser':
        """
