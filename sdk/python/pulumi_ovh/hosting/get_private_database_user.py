...
def get_private_database_user(service_name: Optional[_builtins.str] = None,
...
def get_private_database_user_output(service_name: Optional[pulumi.Input[_builtins.str]] = None,
