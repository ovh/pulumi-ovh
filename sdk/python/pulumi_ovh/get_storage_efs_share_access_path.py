...
def get_storage_efs_share_access_path(id: Optional[builtins.str] = None,
...
def get_storage_efs_share_access_path_output(id: Optional[pulumi.Input[builtins.str]] = None,
