...
def get_network_private_subnets(network_id: Optional[builtins.str] = None,
...
def get_network_private_subnets_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
