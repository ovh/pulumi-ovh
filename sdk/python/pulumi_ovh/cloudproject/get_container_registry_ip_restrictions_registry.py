...
def get_container_registry_ip_restrictions_registry(registry_id: Optional[_builtins.str] = None,
...
def get_container_registry_ip_restrictions_registry_output(registry_id: Optional[pulumi.Input[_builtins.str]] = None,
