...
class GetKubeOidcResult:
    ...
    def oidc_ca_content(self) -> Optional[_builtins.str]:
        """
    ...
    def oidc_groups_claims(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def oidc_groups_prefix(self) -> Optional[_builtins.str]:
        """
    ...
    def oidc_required_claims(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def oidc_signing_algs(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def oidc_username_claim(self) -> Optional[_builtins.str]:
        """
    ...
    def oidc_username_prefix(self) -> Optional[_builtins.str]:
        """
...
def get_kube_oidc(client_id: Optional[_builtins.str] = None,
                  issuer_url: Optional[_builtins.str] = None,
                  kube_id: Optional[_builtins.str] = None,
                  oidc_ca_content: Optional[_builtins.str] = None,
                  oidc_groups_claims: Optional[Sequence[_builtins.str]] = None,
                  oidc_groups_prefix: Optional[_builtins.str] = None,
                  oidc_required_claims: Optional[Sequence[_builtins.str]] = None,
                  oidc_signing_algs: Optional[Sequence[_builtins.str]] = None,
                  oidc_username_claim: Optional[_builtins.str] = None,
                  oidc_username_prefix: Optional[_builtins.str] = None,
    ...
    :param _builtins.str issuer_url: The OIDC issuer url.
    :param _builtins.str kube_id: The id of the managed kubernetes cluster.
    :param _builtins.str oidc_ca_content: Content of the certificate for the CA, in base64 format, that signed your identity provider's web certificate. Defaults to the host's root CAs.
    :param Sequence[_builtins.str] oidc_groups_claims: Array of JWT claim to use as the user's group. If the claim is present it must be an array of strings.
    :param _builtins.str oidc_groups_prefix: Prefix prepended to group claims to prevent clashes with existing names (such as system: groups). For example, the value oidc: will create group names like oidc:engineering and oidc:infra.
    :param Sequence[_builtins.str] oidc_required_claims: Array of key=value pairs that describe required claims in the ID Token. If set, the claims are verified to be present in the ID Token with a matching value."
    :param Sequence[_builtins.str] oidc_signing_algs: Array of signing algorithms accepted. Default is \\"RS256\\".
    :param _builtins.str oidc_username_claim: JWT claim to use as the user name. By default sub, which is expected to be a unique identifier of the end user. Admins can choose other claims, such as email or name, depending on their provider. However, claims other than email will be prefixed with the issuer URL to prevent naming clashes with other plugins.
    :param _builtins.str oidc_username_prefix: Prefix prepended to username claims to prevent clashes with existing names (such as system: users). For example, the value oidc: will create usernames like oidc:jane.doe. If this field isn't set and `oidc_username_claim` is a value other than email the prefix defaults to ( Issuer URL )# where ( Issuer URL ) is the value of oidcIssuerUrl. The value - can be used to disable all prefixing.
...
def get_kube_oidc_output(client_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         issuer_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         kube_id: Optional[pulumi.Input[_builtins.str]] = None,
                         oidc_ca_content: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         oidc_groups_claims: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                         oidc_groups_prefix: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         oidc_required_claims: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                         oidc_signing_algs: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                         oidc_username_claim: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         oidc_username_prefix: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
