...
def get_network_privates(service_name: Optional[_builtins.str] = None,
...
def get_network_privates_output(service_name: Optional[pulumi.Input[_builtins.str]] = None,
