...
class GetM3dbNamespacesResult:
    ...
    def namespace_ids(self) -> Sequence[builtins.str]:
        """
...
def get_m3db_namespaces(cluster_id: Optional[builtins.str] = None,
...
def get_m3db_namespaces_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
