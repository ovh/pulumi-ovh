...
class VolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] size: Volume size
        :param pulumi.Input[str] snapshot_id: Snapshot ID
        :param pulumi.Input[str] type: Type of the volume
        :param pulumi.Input[str] volume_id: Volume ID
        """
...
class _VolumeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action: The action of the operation
        :param pulumi.Input[str] completed_at: The completed date of the operation
        :param pulumi.Input[str] created_at: The creation date of the operation
        :param pulumi.Input[str] description: Volume description
        :param pulumi.Input[str] image_id: Image ID
        :param pulumi.Input[str] instance_id: Instance ID
        :param pulumi.Input[str] name: Volume name
        :param pulumi.Input[float] progress: Volume status
        :param pulumi.Input[str] region_name: Region name
        :param pulumi.Input[Sequence[pulumi.Input[str]]] regions: List of regions
        :param pulumi.Input[str] resource_id: Id of the resource
        :param pulumi.Input[str] service_name: Service name
        :param pulumi.Input[float] size: Volume size
        :param pulumi.Input[str] snapshot_id: Snapshot ID
        :param pulumi.Input[str] started_at: Datetime of the operation creation
        :param pulumi.Input[str] status: Volume status
