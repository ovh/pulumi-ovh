...
def get_container_registry_ip_restrictions_management(registry_id: Optional[builtins.str] = None,
...
def get_container_registry_ip_restrictions_management_output(registry_id: Optional[pulumi.Input[builtins.str]] = None,
