...
def get_volumes(region_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region_name: A valid OVHcloud public cloud region name in which the volumes are available. Ex.: "GRA11".
...
def get_volumes_output(region_name: Optional[pulumi.Input[_builtins.str]] = None,
