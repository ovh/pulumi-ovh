...
class KubeIpRestrictionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ips: List of CIDR authorized to interact with the managed Kubernetes cluster.
...
class KubeIpRestrictions(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ips: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            kube_id: Optional[pulumi.Input[_builtins.str]] = None,
            service_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'KubeIpRestrictions':
        """
