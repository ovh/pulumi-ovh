...
def get_container_registry_users(registry_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str registry_id: Registry ID
...
def get_container_registry_users_output(registry_id: Optional[pulumi.Input[_builtins.str]] = None,
