...
class GetRegionLoadBalancerLogSubscriptionResult:
    ...
    def ldp_service_name(self) -> _builtins.str:
        """
        LDP service name
        """
...
def get_region_load_balancer_log_subscription(loadbalancer_id: Optional[_builtins.str] = None,
...
def get_region_load_balancer_log_subscription_output(loadbalancer_id: Optional[pulumi.Input[_builtins.str]] = None,
