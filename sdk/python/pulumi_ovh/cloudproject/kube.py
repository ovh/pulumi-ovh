...
class KubeArgs:
    def __init__(__self__, *,
                 ...
                 update_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kube_proxy_mode: Selected mode for kube-proxy. **Changing this value recreates the resource, including ETCD user data.** Defaults to `iptables`.
    ...
    def load_balancers_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Subnet ID to use for Public Load Balancers, this subnet must belong to  `private_network_id`. Defaults to the same subnet as the nodes (see `nodes_subnet_id`). Requires `private_network_id` to be defined. See more network requirements in the [documentation](https://help.ovhcloud.com/csm/fr-public-cloud-kubernetes-expose-applications-using-load-balancer?id=kb_article_view&sysparm_article=KB0062873) for more information.
        """
    ...
    def load_balancers_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nodes_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nodes_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def update_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def update_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KubeState:
    def __init__(__self__, *,
                 control_plane_is_up_to_date: Optional[pulumi.Input[builtins.bool]] = None,
                 customization_apiservers: Optional[pulumi.Input[Sequence[pulumi.Input['KubeCustomizationApiserverArgs']]]] = None,
                 customization_kube_proxy: Optional[pulumi.Input['KubeCustomizationKubeProxyArgs']] = None,
                 customizations: Optional[pulumi.Input[Sequence[pulumi.Input['KubeCustomizationArgs']]]] = None,
                 is_up_to_date: Optional[pulumi.Input[builtins.bool]] = None,
                 kube_proxy_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] control_plane_is_up_to_date: True if control-plane is up-to-date.
        :param pulumi.Input[Sequence[pulumi.Input['KubeCustomizationApiserverArgs']]] customization_apiservers: Kubernetes API server customization
        :param pulumi.Input['KubeCustomizationKubeProxyArgs'] customization_kube_proxy: Kubernetes kube-proxy customization
        :param pulumi.Input[Sequence[pulumi.Input['KubeCustomizationArgs']]] customizations: **Deprecated** (Optional) Use `customization_apiserver` and `customization_kube_proxy` instead. Kubernetes cluster customization
        :param pulumi.Input[builtins.bool] is_up_to_date: True if all nodes and control-plane are up-to-date.
        :param pulumi.Input[builtins.str] kube_proxy_mode: Selected mode for kube-proxy. **Changing this value recreates the resource, including ETCD user data.** Defaults to `iptables`.
        :param pulumi.Input[builtins.str] kubeconfig: The kubeconfig file. Use this file to connect to your kubernetes cluster.
        ...
        :param pulumi.Input[builtins.str] update_policy: Cluster update policy. Choose between [ALWAYS_UPDATE, MINIMAL_DOWNTIME, NEVER_UPDATE].
        :param pulumi.Input[builtins.str] url: Management URL of your cluster.
        :param pulumi.Input[builtins.str] version: kubernetes version to use. Changing this value updates the resource. Defaults to the latest available.
        """
    ...
    def control_plane_is_up_to_date(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def control_plane_is_up_to_date(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_up_to_date(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_up_to_date(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def next_upgrade_versions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def next_upgrade_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def nodes_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cluster nodes URL.
        """
    ...
    @nodes_url.setter
    def nodes_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Kube(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_policy: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Kube':
        """
    ...
    @property
    @pulumi.getter(name="controlPlaneIsUpToDate")
    def control_plane_is_up_to_date(self) -> pulumi.Output[builtins.bool]:
        """
        True if control-plane is up-to-date.
        """
        return pulumi.get(self, "control_plane_is_up_to_date")
    ...
    @property
    @pulumi.getter(name="loadBalancersSubnetId")
    def load_balancers_subnet_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Subnet ID to use for Public Load Balancers, this subnet must belong to  `private_network_id`. Defaults to the same subnet as the nodes (see `nodes_subnet_id`). Requires `private_network_id` to be defined. See more network requirements in the [documentation](https://help.ovhcloud.com/csm/fr-public-cloud-kubernetes-expose-applications-using-load-balancer?id=kb_article_view&sysparm_article=KB0062873) for more information.
        """
        return pulumi.get(self, "load_balancers_subnet_id")
    ...
    @property
    @pulumi.getter(name="nextUpgradeVersions")
    def next_upgrade_versions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Kubernetes versions available for upgrade.
        """
        return pulumi.get(self, "next_upgrade_versions")
    ...
    @property
    @pulumi.getter(name="nodesSubnetId")
    def nodes_subnet_id(self) -> pulumi.Output[builtins.str]:
        """
        Subnet ID to use for nodes, this subnet must belong to `private_network_id`. Default uses the first subnet belonging to the private network with id `private_network_id`. This attribute requires `private_network_id` to be defined. **Cannot be updated, it can only be used at cluster creation or reset.**
        """
        return pulumi.get(self, "nodes_subnet_id")
    ...
    @property
    @pulumi.getter(name="nodesUrl")
    def nodes_url(self) -> pulumi.Output[builtins.str]:
        """
        Cluster nodes URL.
        """
        return pulumi.get(self, "nodes_url")
    ...
    @property
    @pulumi.getter(name="updatePolicy")
    def update_policy(self) -> pulumi.Output[builtins.str]:
        """
        Cluster update policy. Choose between [ALWAYS_UPDATE, MINIMAL_DOWNTIME, NEVER_UPDATE].
        """
        return pulumi.get(self, "update_policy")
