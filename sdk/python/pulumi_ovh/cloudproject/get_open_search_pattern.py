...
class GetOpenSearchPatternResult:
    ...
    def max_index_count(self) -> builtins.int:
        """
...
def get_open_search_pattern(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Pattern ID.
...
def get_open_search_pattern_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
