...
def get_container_registries(service_name: Optional[_builtins.str] = None,
...
def get_container_registries_output(service_name: Optional[pulumi.Input[_builtins.str]] = None,
