...
def get_container_registries(service_name: Optional[builtins.str] = None,
...
def get_container_registries_output(service_name: Optional[pulumi.Input[builtins.str]] = None,
