...
class GetDatabasePostgreSQLConnectionPoolsResult:
    ...
    def connection_pool_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_database_postgre_sql_connection_pools(cluster_id: Optional[_builtins.str] = None,
...
def get_database_postgre_sql_connection_pools_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
