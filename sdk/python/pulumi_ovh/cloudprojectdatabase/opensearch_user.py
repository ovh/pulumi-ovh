...
class OpensearchUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Username affected by this acl. A user named "avnadmin" is mapped with already created admin user and reset his password instead of creating a new user.
...
@pulumi.type_token("ovh:CloudProjectDatabase/opensearchUser:OpensearchUser")
class OpensearchUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password_reset: Optional[pulumi.Input[_builtins.str]] = None,
            service_name: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'OpensearchUser':
        """
