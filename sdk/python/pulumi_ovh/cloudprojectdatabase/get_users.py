...
def get_users(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str engine: The engine of the database cluster you want to list users. To get a full list of available engine visit: [public documentation](https://docs.ovh.com/gb/en/publiccloud/databases).
...
def get_users_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
