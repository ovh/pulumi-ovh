...
class PostgresSqlConnectionPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_id: Database ID for a database that belongs to the Database cluster given above.
        :param pulumi.Input[_builtins.str] mode: Connection mode to the connection pool Available modes:
        :param pulumi.Input[_builtins.int] size: Size of the connection pool.
        :param pulumi.Input[_builtins.str] name: Name of the connection pool.
        ...
        :param pulumi.Input[_builtins.str] user_id: Database user authorized to connect to the pool, if none all the users are allowed.
        """
...
class _PostgresSqlConnectionPoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mode: Connection mode to the connection pool Available modes:
        :param pulumi.Input[_builtins.str] name: Name of the connection pool.
        :param pulumi.Input[_builtins.int] port: Port of the connection pool.
        :param pulumi.Input[_builtins.str] service_name: The id of the public cloud project. If omitted, the `OVH_CLOUD_PROJECT_SERVICE` environment variable is used.
        :param pulumi.Input[_builtins.int] size: Size of the connection pool.
        :param pulumi.Input[_builtins.str] ssl_mode: Ssl connection mode for the pool.
        :param pulumi.Input[_builtins.str] uri: Connection URI to the pool.
        :param pulumi.Input[_builtins.str] user_id: Database user authorized to connect to the pool, if none all the users are allowed.
        """
...
@pulumi.type_token("ovh:CloudProjectDatabase/postgresSqlConnectionPool:PostgresSqlConnectionPool")
class PostgresSqlConnectionPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_mode: Optional[pulumi.Input[_builtins.str]] = None,
            uri: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PostgresSqlConnectionPool':
        """
