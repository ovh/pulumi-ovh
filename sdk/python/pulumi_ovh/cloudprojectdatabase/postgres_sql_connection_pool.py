...
class PostgresSqlConnectionPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_id: Database ID for a database that belongs to the Database cluster given above.
        :param pulumi.Input[builtins.str] mode: Connection mode to the connection pool Available modes:
        ...
        :param pulumi.Input[builtins.int] size: Size of the connection pool.
        :param pulumi.Input[builtins.str] name: Name of the connection pool.
        :param pulumi.Input[builtins.str] user_id: Database user authorized to connect to the pool, if none all the users are allowed.
        """
...
class _PostgresSqlConnectionPoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] mode: Connection mode to the connection pool Available modes:
        :param pulumi.Input[builtins.str] name: Name of the connection pool.
        :param pulumi.Input[builtins.int] port: Port of the connection pool.
        :param pulumi.Input[builtins.str] service_name: The id of the public cloud project. If omitted, the `OVH_CLOUD_PROJECT_SERVICE` environment variable is used.
        :param pulumi.Input[builtins.int] size: Size of the connection pool.
        :param pulumi.Input[builtins.str] ssl_mode: Ssl connection mode for the pool.
        :param pulumi.Input[builtins.str] uri: Connection URI to the pool.
        :param pulumi.Input[builtins.str] user_id: Database user authorized to connect to the pool, if none all the users are allowed.
        """
...
class PostgresSqlConnectionPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_mode: Optional[pulumi.Input[builtins.str]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PostgresSqlConnectionPool':
        """
