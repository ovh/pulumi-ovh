...
class KafkaTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] min_insync_replicas: Minimum insync replica accepted for this topic. Should be superior to 0
        :param pulumi.Input[builtins.str] name: Name of the topic. No spaces allowed.
        :param pulumi.Input[builtins.int] partitions: Number of partitions for this topic. Should be superior to 0
        :param pulumi.Input[builtins.int] replication: Number of replication for this topic. Should be superior to 1
        :param pulumi.Input[builtins.int] retention_bytes: Number of bytes for the retention of the data for this topic. Inferior to 0 means unlimited
        :param pulumi.Input[builtins.int] retention_hours: Number of hours for the retention of the data for this topic. Should be superior to -2. Inferior to 0 means unlimited
...
class KafkaTopic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_bytes: Optional[pulumi.Input[builtins.int]] = None,
            retention_hours: Optional[pulumi.Input[builtins.int]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None) -> 'KafkaTopic':
        """
    ...
    @property
    @pulumi.getter(name="minInsyncReplicas")
    def min_insync_replicas(self) -> pulumi.Output[builtins.int]:
        """
        Minimum insync replica accepted for this topic. Should be superior to 0
        """
        return pulumi.get(self, "min_insync_replicas")
