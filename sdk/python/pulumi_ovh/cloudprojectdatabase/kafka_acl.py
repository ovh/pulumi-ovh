...
class KafkaAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permission: Permission to give to this username on this topic. Available permissions:
        :param pulumi.Input[builtins.str] topic: Topic affected by this ACL.
        :param pulumi.Input[builtins.str] username: Username affected by this ACL.
