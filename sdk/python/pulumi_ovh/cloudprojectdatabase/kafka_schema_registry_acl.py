...
class KafkaSchemaRegistryAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permission: Permission to give to this username on this resource. Available permissions:
        :param pulumi.Input[builtins.str] resource: Resource affected by this schema registry ACL.
        :param pulumi.Input[builtins.str] username: Username affected by this schema registry ACL.
...
@pulumi.type_token("ovh:CloudProjectDatabase/kafkaSchemaRegistryAcl:KafkaSchemaRegistryAcl")
