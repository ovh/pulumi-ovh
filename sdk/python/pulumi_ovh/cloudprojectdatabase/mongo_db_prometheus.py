...
class _MongoDbPrometheusState:
    def __init__(__self__, *,
                 ...
                 password_reset: Optional[pulumi.Input[_builtins.str]] = None,
                 service_name: Optional[pulumi.Input[_builtins.str]] = None,
                 srv_domain: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] password_reset: Arbitrary string to change to trigger a password update
        :param pulumi.Input[_builtins.str] service_name: The id of the public cloud project. If omitted, the `OVH_CLOUD_PROJECT_SERVICE` environment variable is used.
        :param pulumi.Input[_builtins.str] srv_domain: Name of the srv domain endpoint.
    ...
    def srv_domain(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @srv_domain.setter
    def srv_domain(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class MongoDbPrometheus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[_builtins.str]] = None,
            srv_domain: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None) -> 'MongoDbPrometheus':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="srvDomain")
    def srv_domain(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the srv domain endpoint.
        """
        return pulumi.get(self, "srv_domain")
