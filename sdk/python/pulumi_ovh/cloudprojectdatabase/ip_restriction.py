...
class IpRestrictionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] engine: The engine of the database cluster you want to add an IP restriction. To get a full list of available engine visit. [public documentation](https://docs.ovh.com/gb/en/publiccloud/databases).
...
class _IpRestrictionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip: Authorized IP.
        :param pulumi.Input[_builtins.str] service_name: The id of the public cloud project. If omitted, the `OVH_CLOUD_PROJECT_SERVICE` environment variable is used.
        :param pulumi.Input[_builtins.str] status: Current status of the IP restriction.
        """
...
class IpRestriction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip: Optional[pulumi.Input[_builtins.str]] = None,
            service_name: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'IpRestriction':
        """
