...
def get_kafka_schema_registry_acls(cluster_id: Optional[_builtins.str] = None,
...
def get_kafka_schema_registry_acls_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
