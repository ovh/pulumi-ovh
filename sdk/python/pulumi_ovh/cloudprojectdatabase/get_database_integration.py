...
class GetDatabaseIntegrationResult:
    ...
    def source_service_id(self) -> _builtins.str:
        """
...
def get_database_integration(cluster_id: Optional[_builtins.str] = None,
...
def get_database_integration_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
