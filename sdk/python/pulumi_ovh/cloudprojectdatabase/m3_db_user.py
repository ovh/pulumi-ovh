...
class M3DbUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group: Group of the user.
        :param pulumi.Input[builtins.str] name: Name of the user. A user named "avnadmin" is mapped with already created admin user instead of creating a new user.
...
class M3DbUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password_reset: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'M3DbUser':
        """
