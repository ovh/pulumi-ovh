...
class MongoDbUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] roles: Roles the user belongs to with the authentication database
        """
...
class MongoDbUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MongoDbUser resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            service_name: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'MongoDbUser':
        """
