...
__all__ = ['MongoDbUserArgs', 'MongoDbUser']

@pulumi.input_type
class MongoDbUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the user. A user named "admin" is mapped with already created admin@admin user instead of creating a new user.
        :param pulumi.Input[_builtins.str] password_reset: Arbitrary string to change to trigger a password update
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: Roles the user belongs to. Since version 0.37.0, the authentication database must be indicated for all roles. Available roles:
               * `backup@admin`
               * `clusterAdmin@admin`
...
@pulumi.type_token("ovh:CloudProjectDatabase/mongoDbUser:MongoDbUser")
class MongoDbUser(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MongoDbUserArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MongoDbUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MongoDbUserArgs.__new__(MongoDbUserArgs)
        ...
        super(MongoDbUser, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            service_name: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'MongoDbUser':
        """
        ...
        __props__ = _MongoDbUserState.__new__(_MongoDbUserState)
        ...
        return MongoDbUser(resource_name, opts=opts, __props__=__props__)
