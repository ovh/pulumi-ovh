...
def get_postgres_sql_connection_pool(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of the Connection pool.
...
def get_postgres_sql_connection_pool_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
