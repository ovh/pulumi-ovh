...
class GetLogsOutputOpenSearchIndexResult:
    ...
    def alert_notify_enabled(self) -> _builtins.bool:
        """
    ...
    def nb_shard(self) -> _builtins.int:
        """
        Number of shard
        """
...
def get_logs_output_open_search_index(name: Optional[_builtins.str] = None,
                                      nb_shard: Optional[_builtins.int] = None,
    ...
    :param _builtins.int nb_shard: Number of shard
...
def get_logs_output_open_search_index_output(name: Optional[pulumi.Input[_builtins.str]] = None,
                                             nb_shard: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
