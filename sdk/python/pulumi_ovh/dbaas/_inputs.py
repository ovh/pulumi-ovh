...
if not MYPY:
    class LogsInputConfigurationFlowggerArgsDict(TypedDict):
        ...
        """
        log_framing: pulumi.Input[_builtins.str]
        """
...
class LogsInputConfigurationFlowggerArgs:
    def __init__(__self__, *,
                 ...
                 log_framing: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] log_format: Type of format to decode. One of "RFC5424", "LTSV", "GELF", "CAPNP"
        :param pulumi.Input[_builtins.str] log_framing: Indicates how messages are delimited. One of "LINE", "NUL", "SYSLEN", "CAPNP"
        """
    ...
    def log_framing(self) -> pulumi.Input[_builtins.str]:
        """
        Indicates how messages are delimited. One of "LINE", "NUL", "SYSLEN", "CAPNP"
        """
    ...
    @log_framing.setter
    def log_framing(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "log_framing", value)


if not MYPY:
    class LogsInputConfigurationLogstashArgsDict(TypedDict):
        input_section: pulumi.Input[_builtins.str]
        """
        The filter section of logstash.conf
        """
        filter_section: NotRequired[pulumi.Input[_builtins.str]]
        """
        The filter section of logstash.conf
        """
        pattern_section: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class LogsInputConfigurationLogstashArgs:
    def __init__(__self__, *,
                 input_section: pulumi.Input[_builtins.str],
                 filter_section: Optional[pulumi.Input[_builtins.str]] = None,
                 pattern_section: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] input_section: The filter section of logstash.conf
        :param pulumi.Input[_builtins.str] filter_section: The filter section of logstash.conf
        :param pulumi.Input[_builtins.str] pattern_section: The list of customs Grok patterns
        """
    ...
    def input_section(self) -> pulumi.Input[_builtins.str]:
        """
        The filter section of logstash.conf
        """
    ...
    def input_section(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "input_section", value)

    @_builtins.property
    @pulumi.getter(name="filterSection")
    def filter_section(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The filter section of logstash.conf
        """
    ...
    def filter_section(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "filter_section", value)

    @_builtins.property
    @pulumi.getter(name="patternSection")
    def pattern_section(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The list of customs Grok patterns
        """
    ...
    def pattern_section(self, value: Optional[pulumi.Input[_builtins.str]]):
