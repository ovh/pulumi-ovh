...
class LogsClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] archive_allowed_networks: Allowed networks for ARCHIVE flow type
        :param pulumi.Input[Sequence[pulumi.Input[str]]] direct_input_allowed_networks: Allowed networks for DIRECT_INPUT flow type
        :param pulumi.Input[Sequence[pulumi.Input[str]]] query_allowed_networks: Allowed networks for QUERY flow type
        """
...
class _LogsClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] is_default: All content generated by given service will be placed on this cluster
        :param pulumi.Input[bool] is_unlocked: Allow given service to perform advanced operations on cluster
        :param pulumi.Input[Sequence[pulumi.Input[str]]] query_allowed_networks: Allowed networks for QUERY flow type
        :param pulumi.Input[str] region: Data center localization
        """
        if archive_allowed_networks is not None:
            pulumi.set(__self__, "archive_allowed_networks", archive_allowed_networks)
        if cluster_id is not None:
...
class LogsCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LogsCluster resource with the given unique name, props, and options.
