...
class LogsInputConfigurationFlowgger(dict):
    ...
    def __init__(__self__, *,
                 ...
                 log_framing: _builtins.str):
        """
        :param _builtins.str log_format: Type of format to decode. One of "RFC5424", "LTSV", "GELF", "CAPNP"
        :param _builtins.str log_framing: Indicates how messages are delimited. One of "LINE", "NUL", "SYSLEN", "CAPNP"
        """
    ...
    def log_framing(self) -> _builtins.str:
        """
...
class LogsInputConfigurationLogstash(dict):
    ...
    def __init__(__self__, *,
                 input_section: _builtins.str,
                 filter_section: Optional[_builtins.str] = None,
                 pattern_section: Optional[_builtins.str] = None):
        """
        :param _builtins.str input_section: The filter section of logstash.conf
        :param _builtins.str filter_section: The filter section of logstash.conf
        :param _builtins.str pattern_section: The list of customs Grok patterns
        """
    ...
    def input_section(self) -> _builtins.str:
        """
    ...
    def filter_section(self) -> Optional[_builtins.str]:
        """
        The filter section of logstash.conf
        """
    ...
    def pattern_section(self) -> Optional[_builtins.str]:
        """
