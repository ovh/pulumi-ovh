...
def get_logs_input_engine(is_deprecated: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool is_deprecated: Indicates if engine will soon not be supported.
    :param _builtins.str name: The name of the logs input engine.
...
def get_logs_input_engine_output(is_deprecated: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
