...
class GetLogsClustersResult:
    ...
    @_builtins.property
    @pulumi.getter
    def uuids(self) -> Sequence[_builtins.str]:
        """
        is the cluster id
        """
...
def get_logs_clusters(service_name: Optional[_builtins.str] = None,
...
def get_logs_clusters_output(service_name: Optional[pulumi.Input[_builtins.str]] = None,
