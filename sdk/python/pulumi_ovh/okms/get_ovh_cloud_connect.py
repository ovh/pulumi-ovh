...
__all__ = [
    'GetOvhCloudConnectResult',
    'AwaitableGetOvhCloudConnectResult',
    'get_ovh_cloud_connect',
    'get_ovh_cloud_connect_output',
]

@pulumi.output_type
class GetOvhCloudConnectResult:
    """
    ...
    @property
    @pulumi.getter
    def iam(self) -> 'outputs.GetOvhCloudConnectIamResult':
...
class AwaitableGetOvhCloudConnectResult(GetOvhCloudConnectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvhCloudConnectResult(
...
def get_ovh_cloud_connect(service_name: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvhCloudConnectResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:Okms/getOvhCloudConnect:getOvhCloudConnect', __args__, opts=opts, typ=GetOvhCloudConnectResult).value

    return AwaitableGetOvhCloudConnectResult(
...
def get_ovh_cloud_connect_output(service_name: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOvhCloudConnectResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('ovh:Okms/getOvhCloudConnect:getOvhCloudConnect', __args__, opts=opts, typ=GetOvhCloudConnectResult)
    return __ret__.apply(lambda __response__: GetOvhCloudConnectResult(
