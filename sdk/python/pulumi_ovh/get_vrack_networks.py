...
def get_vrack_networks(service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str subnet: Filters networks on the subnet.
    :param _builtins.int vlan_id: Filters networks on the vlan id.
    """
    __args__ = dict()
...
def get_vrack_networks_output(service_name: Optional[pulumi.Input[_builtins.str]] = None,
                              subnet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              vlan_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
