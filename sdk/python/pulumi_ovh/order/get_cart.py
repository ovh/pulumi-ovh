...
class GetCartResult:
    ...
    @property
    @pulumi.getter
    def assign(self) -> Optional[builtins.bool]:
    ...
    def ovh_subsidiary(self) -> builtins.str:
...
def get_cart(assign: Optional[builtins.bool] = None,
             description: Optional[builtins.str] = None,
             expire: Optional[builtins.str] = None,
             ovh_subsidiary: Optional[builtins.str] = None,
    ...
    :param builtins.bool assign: Assign a shopping cart to a logged in client. Values can be `true` or `false`.
    :param builtins.str description: Description of your cart
    :param builtins.str expire: Expiration time (format: 2006-01-02T15:04:05+00:00)
    :param builtins.str ovh_subsidiary: OVHcloud Subsidiary. Country of OVHcloud legal entity you'll be billed by. List of supported subsidiaries available on API at [/1.0/me.json under `models.nichandle.OvhSubsidiaryEnum`](https://eu.api.ovh.com/1.0/me.json)
    """
    __args__ = dict()
...
def get_cart_output(assign: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    expire: Optional[pulumi.Input[Optional[builtins.str]]] = None,
