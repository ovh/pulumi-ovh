...
class GetIdentityUserResult:
    ...
    def user_urn(self) -> _builtins.str:
        """
        User's identity URN.
        """
    ...
    def password_last_update(self) -> _builtins.str:
        """
...
def get_identity_user(user: Optional[_builtins.str] = None,
    ...
    :param _builtins.str user: User's login.
    """
    __args__ = dict()
    __args__['user'] = user
...
def get_identity_user_output(user: Optional[pulumi.Input[_builtins.str]] = None,
