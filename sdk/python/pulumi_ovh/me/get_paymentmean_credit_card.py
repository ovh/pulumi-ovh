...
class GetPaymentmeanCreditCardResult:
    ...
    def use_last_to_expire(self) -> Optional[_builtins.bool]:
...
def get_paymentmean_credit_card(description_regexp: Optional[_builtins.str] = None,
                                states: Optional[Sequence[_builtins.str]] = None,
                                use_default: Optional[_builtins.bool] = None,
                                use_last_to_expire: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str description_regexp: a regexp used to filter credit cards on their `description` attributes.
    :param Sequence[_builtins.str] states: Filter credit cards on their `state` attribute. Can be "expired", "valid", "tooManyFailures"
    :param _builtins.bool use_default: Retrieve credit card marked as default payment mean.
    :param _builtins.bool use_last_to_expire: Retrieve the credit card that will be the last to expire according to its expiration date.
    """
    __args__ = dict()
...
def get_paymentmean_credit_card_output(description_regexp: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       use_last_to_expire: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
