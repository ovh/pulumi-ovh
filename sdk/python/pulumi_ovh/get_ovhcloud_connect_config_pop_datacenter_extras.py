...
class GetOvhcloudConnectConfigPopDatacenterExtrasResult:
    ...
    def config_datacenter_id(self) -> _builtins.float:
        """
...
def get_ovhcloud_connect_config_pop_datacenter_extras(config_datacenter_id: Optional[_builtins.float] = None,
                                                      config_pop_id: Optional[_builtins.float] = None,
    ...
    :param _builtins.float config_datacenter_id: ID of the Datacenter Configuration
...
def get_ovhcloud_connect_config_pop_datacenter_extras_output(config_datacenter_id: Optional[pulumi.Input[_builtins.float]] = None,
