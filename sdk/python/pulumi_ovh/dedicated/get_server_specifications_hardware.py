...
class GetServerSpecificationsHardwareResult:
    ...
    def cores_per_processor(self) -> _builtins.float:
        """
    ...
    def form_factor(self) -> _builtins.str:
        """
        Server form factor
        """
    ...
    @_builtins.property
    @pulumi.getter
    def motherboard(self) -> _builtins.str:
        """
        Server motherboard
        """
    ...
    def number_of_processors(self) -> _builtins.float:
        """
    ...
    def processor_architecture(self) -> _builtins.str:
        """
    ...
    def threads_per_processor(self) -> _builtins.float:
        """
...
def get_server_specifications_hardware(service_name: Optional[_builtins.str] = None,
...
def get_server_specifications_hardware_output(service_name: Optional[pulumi.Input[_builtins.str]] = None,
