...
class GetServerBootsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence[_builtins.int]:
        """
...
def get_server_boots(boot_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str boot_type: Filter the value of bootType property (harddisk, rescue, internal, network)
    :param _builtins.str kernel: Filter the value of kernel property (iPXE script name)
...
def get_server_boots_output(boot_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            kernel: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
