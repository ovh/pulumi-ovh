...
class GetNasHAPartitionResult:
    ...
    def used_by_snapshots(self) -> _builtins.int:
        """
...
def get_nas_ha_partition(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of your dedicated HA-NAS partition.
...
def get_nas_ha_partition_output(name: Optional[pulumi.Input[_builtins.str]] = None,
