...
class _IpServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] can_be_terminated: can be terminated
        :param pulumi.Input[builtins.str] country: country
        :param pulumi.Input[builtins.str] description: Custom description on your ip.
        :param pulumi.Input[builtins.str] ip: ip block
        :param pulumi.Input[Sequence[pulumi.Input['IpServiceOrderArgs']]] orders: Details about an Order
...
class IpService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'IpService':
        """
