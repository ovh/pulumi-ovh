...
class IpServiceOrderDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str description: Custom description on your ip.
...
class MoveRoutedTo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service_name: Name of the service to route the IP to. IP will be parked if this value is an empty string
        """
        pulumi.set(__self__, "service_name", service_name)
