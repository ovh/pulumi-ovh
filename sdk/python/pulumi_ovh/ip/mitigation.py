...
class MitigationArgs:
    def __init__(__self__, *,
                 ...
                 ip_on_mitigation: pulumi.Input[_builtins.str],
    ...
    def ip_on_mitigation(self, value: pulumi.Input[_builtins.str]):
...
class _MitigationState:
    ...
    @ip_on_mitigation.setter
    def ip_on_mitigation(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "ip_on_mitigation", value)
...
@pulumi.type_token("ovh:Ip/mitigation:Mitigation")
class Mitigation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_on_mitigation: Optional[pulumi.Input[_builtins.str]] = None,
            permanent: Optional[pulumi.Input[_builtins.bool]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None) -> 'Mitigation':
        """
