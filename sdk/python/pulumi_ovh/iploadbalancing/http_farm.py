...
class HttpFarmArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] balance: Load balancing algorithm. `roundrobin` if null (`first`, `leastconn`, `roundrobin`, `source`, `uri`)
        ...
        :param pulumi.Input[_builtins.str] stickiness: Stickiness type. No stickiness if null (`sourceIp`, `cookie`)
...
class HttpFarm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stickiness: Optional[pulumi.Input[_builtins.str]] = None,
            vrack_network_id: Optional[pulumi.Input[_builtins.int]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'HttpFarm':
        """
