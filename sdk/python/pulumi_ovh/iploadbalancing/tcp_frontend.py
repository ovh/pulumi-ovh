...
class TcpFrontendArgs:
    def __init__(__self__, *,
                 ...
                 denied_sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] denied_sources: Deny IP Load Balancing access to these ip block. No restriction if null. You cannot specify both `allowed_source` and `denied_source` at the same time. List of IP blocks.
    ...
    def denied_sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def denied_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class TcpFrontend(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            ssl: Optional[pulumi.Input[builtins.bool]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'TcpFrontend':
        """
    ...
    @property
    @pulumi.getter(name="deniedSources")
    def denied_sources(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Deny IP Load Balancing access to these ip block. No restriction if null. You cannot specify both `allowed_source` and `denied_source` at the same time. List of IP blocks.
        """
        return pulumi.get(self, "denied_sources")
