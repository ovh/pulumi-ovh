...
class _HttpFarmServerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: Address of the backend server (IP from either internal or OVHcloud network)
        :param pulumi.Input[builtins.bool] backup: is it a backup server used in case of failure of all the non-backup backends
        :param pulumi.Input[builtins.str] cookie: Value of the stickiness cookie used for this backend.
        :param pulumi.Input[builtins.str] display_name: Label for the server
        :param pulumi.Input[builtins.int] farm_id: ID of the farm this server is attached to
        :param pulumi.Input[builtins.str] on_marked_down: enable action when backend marked down. (`shutdown-sessions`)
        :param pulumi.Input[builtins.int] port: Port that backend will respond on
...
class HttpFarmServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'HttpFarmServer':
        """
