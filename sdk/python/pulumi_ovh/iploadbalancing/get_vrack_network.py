...
class GetVrackNetworkResult:
    ...
    def vrack_network_id(self) -> builtins.int:
...
def get_vrack_network(service_name: Optional[builtins.str] = None,
                      vrack_network_id: Optional[builtins.int] = None,
    ...
    :param builtins.int vrack_network_id: Internal Load Balancer identifier of the vRack private network
    """
    __args__ = dict()
...
def get_vrack_network_output(service_name: Optional[pulumi.Input[builtins.str]] = None,
