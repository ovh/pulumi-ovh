...
class IpLoadbalancingArgs:
    def __init__(__self__, *,
                 loadbalancing_id: pulumi.Input[builtins.str],
                 service_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a IpLoadbalancing resource.
        :param pulumi.Input[builtins.str] loadbalancing_id: The id of the IP Load Balancing.
        :param pulumi.Input[builtins.str] service_name: The id of the vrack.
        """
    ...
    def loadbalancing_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def loadbalancing_id(self, value: pulumi.Input[builtins.str]):
...
class _IpLoadbalancingState:
    def __init__(__self__, *,
                 loadbalancing_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="LoadbalancingId")
    def loadbalancing_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the IP Load Balancing.
        """
        return pulumi.get(self, "loadbalancing_id")
    ...
    @loadbalancing_id.setter
    def loadbalancing_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "loadbalancing_id", value)
...
@pulumi.type_token("ovh:Vrack/ipLoadbalancing:IpLoadbalancing")
class IpLoadbalancing(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            loadbalancing_id: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IpLoadbalancing':
        """
    ...
    @property
    @pulumi.getter(name="LoadbalancingId")
    def loadbalancing_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the IP Load Balancing.
        """
        return pulumi.get(self, "loadbalancing_id")
