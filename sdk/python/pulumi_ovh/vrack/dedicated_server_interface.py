...
class DedicatedServerInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] interface_id: The id of dedicated server network interface.
        :param pulumi.Input[builtins.str] service_name: The id of the vrack. If omitted, the `OVH_VRACK_SERVICE` environment variable is used.
        """
...
class DedicatedServerInterface(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            interface_id: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DedicatedServerInterface':
        """
