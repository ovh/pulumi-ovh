...
def get_permissions_group(allows: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] allows: Set of actions allowed by the permissions group.
    :param Sequence[_builtins.str] denies: Set of actions that will always be denied even if it is explicitly allowed by a policy.
    ...
    :param _builtins.str updated_at: Date of the last update of this group.
    :param _builtins.str urn: URN of the permissions group.
    """
    __args__ = dict()
...
def get_permissions_group_output(allows: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
