...
class ZoneRecordArgs:
    def __init__(__self__, *,
                 fieldtype: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] fieldtype: The type of the record
        :param pulumi.Input[_builtins.str] target: The value of the record
        :param pulumi.Input[_builtins.str] zone: The domain to add the record to
        :param pulumi.Input[_builtins.str] subdomain: The name of the record. It can be an empty string.
        :param pulumi.Input[_builtins.int] ttl: The TTL of the record, it shall be >= to 60.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def fieldtype(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @fieldtype.setter
    def fieldtype(self, value: pulumi.Input[_builtins.str]):
...
class _ZoneRecordState:
    def __init__(__self__, *,
                 fieldtype: Optional[pulumi.Input[_builtins.str]] = None,
                 subdomain: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def fieldtype(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The type of the record
        """
        return pulumi.get(self, "fieldtype")
    ...
    @fieldtype.setter
    def fieldtype(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "fieldtype", value)
...
@pulumi.type_token("ovh:Domain/zoneRecord:ZoneRecord")
class ZoneRecord(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def fieldtype(self) -> pulumi.Output[_builtins.str]:
        """
        The type of the record
        """
        return pulumi.get(self, "fieldtype")
