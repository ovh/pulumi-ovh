...
class NameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] checksum: Computed hash used to control concurrent modification requests. Here, it represents the current target specification value
...
class _NameState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ovh_subsidiary: OVH subsidiaries
        :param pulumi.Input[builtins.str] resource_status: Reflects the readiness of the domain name resource. A new target specification request will be accepted only in `READY`, `UPDATING` or `ERROR` status
        :param pulumi.Input['NameTargetSpecArgs'] target_spec: Latest target specification of the domain name resource.
        """
        if checksum is not None:
            pulumi.set(__self__, "checksum", checksum)
