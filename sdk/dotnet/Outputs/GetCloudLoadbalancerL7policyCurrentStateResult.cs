...
namespace Pulumi.Ovh.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudLoadbalancerL7policyCurrentStateResult
    {
        /// <summary>
        /// L7 policy action.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCloudLoadbalancerL7policyCurrentStateRuleResult> Rules;

        [OutputConstructor]
        private GetCloudLoadbalancerL7policyCurrentStateResult(
            string action,
            ...
            ImmutableArray<Outputs.GetCloudLoadbalancerL7policyCurrentStateRuleResult> rules)
        {
            Action = action;
