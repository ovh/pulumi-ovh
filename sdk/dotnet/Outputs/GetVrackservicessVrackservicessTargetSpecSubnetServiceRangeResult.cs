...
namespace Pulumi.Ovh.Outputs
{
    ...
    [OutputType]
    public sealed class GetVrackservicessVrackservicessTargetSpecSubnetServiceRangeResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetVrackservicessVrackservicessTargetSpecSubnetServiceRangeResult(string cidr)
        {
            Cidr = cidr;
        }
    }
