...
namespace Pulumi.Ovh.Dedicated.Inputs
{
    ...
    public sealed class ServerStoragePartitioningLayoutGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Partition extras parameters
        /// </summary>
        [Input("extras")]
        public Input<Inputs.ServerStoragePartitioningLayoutExtrasGetArgs>? Extras { get; set; }
        ...
        public ServerStoragePartitioningLayoutGetArgs()
        {
        }
        public static new ServerStoragePartitioningLayoutGetArgs Empty => new ServerStoragePartitioningLayoutGetArgs();
    }
}
