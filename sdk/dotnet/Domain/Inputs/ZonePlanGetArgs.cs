...
namespace ediri.Ovh.Domain.Inputs
{
    ...
    public sealed class ZonePlanGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Catalog name
        /// </summary>
        ...
        {
            get => _configurations ?? (_configurations = new InputList<Inputs.ZonePlanConfigurationGetArgs>());
        ...
        public ZonePlanGetArgs()
        {
        }
        public static new ZonePlanGetArgs Empty => new ZonePlanGetArgs();
    }
}
