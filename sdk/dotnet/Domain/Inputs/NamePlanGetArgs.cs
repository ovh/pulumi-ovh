...
namespace Pulumi.Ovh.Domain.Inputs
{
    ...
    public sealed class NamePlanGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("configurations")]
        private InputList<Inputs.NamePlanConfigurationGetArgs>? _configurations;
        public InputList<Inputs.NamePlanConfigurationGetArgs> Configurations
        {
            get => _configurations ?? (_configurations = new InputList<Inputs.NamePlanConfigurationGetArgs>());
        ...
        public NamePlanGetArgs()
        {
        }
        public static new NamePlanGetArgs Empty => new NamePlanGetArgs();
    }
}
