...
namespace ediri.Ovh.Domain.Inputs
{
    ...
    public sealed class ZonePlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ZonePlanConfigurationArgs>? _configurations;

        /// <summary>
        /// Representation of a configuration item for personalizing product
        /// </summary>
        public InputList<Inputs.ZonePlanConfigurationArgs> Configurations
        {
            get => _configurations ?? (_configurations = new InputList<Inputs.ZonePlanConfigurationArgs>());
