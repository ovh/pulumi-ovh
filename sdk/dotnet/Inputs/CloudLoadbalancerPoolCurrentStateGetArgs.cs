...
namespace Pulumi.Ovh.Inputs
{
    ...
    public sealed class CloudLoadbalancerPoolCurrentStateGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("healthMonitor")]
        public Input<Inputs.CloudLoadbalancerPoolCurrentStateHealthMonitorGetArgs>? HealthMonitor { get; set; }
        ...
        /// </summary>
        [Input("persistence")]
        public Input<Inputs.CloudLoadbalancerPoolCurrentStatePersistenceGetArgs>? Persistence { get; set; }
        ...
        public CloudLoadbalancerPoolCurrentStateGetArgs()
        {
        }
        public static new CloudLoadbalancerPoolCurrentStateGetArgs Empty => new CloudLoadbalancerPoolCurrentStateGetArgs();
    }
}
