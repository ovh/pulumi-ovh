...
namespace Pulumi.Ovh.Inputs
{
    ...
    public sealed class CloudInstanceCurrentStateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Observed flavor of the instance, with its full sizing details:
        /// </summary>
        [Input("flavor")]
        public Input<Inputs.CloudInstanceCurrentStateFlavorArgs>? Flavor { get; set; }

        /// <summary>
        /// Instance (placement) group the instance belongs to, null when it is not part of any group:
        /// </summary>
        [Input("group")]
        public Input<Inputs.CloudInstanceCurrentStateGroupArgs>? Group { get; set; }
        ...
        /// </summary>
        [Input("image")]
        public Input<Inputs.CloudInstanceCurrentStateImageArgs>? Image { get; set; }

        /// <summary>
        /// Observed region and availability zone where the instance is provisioned:
        /// </summary>
        [Input("location")]
        public Input<Inputs.CloudInstanceCurrentStateLocationArgs>? Location { get; set; }
        ...
        [Input("networks")]
        private InputList<Inputs.CloudInstanceCurrentStateNetworkArgs>? _networks;
        ...
        /// </summary>
        public InputList<Inputs.CloudInstanceCurrentStateNetworkArgs> Networks
        {
            get => _networks ?? (_networks = new InputList<Inputs.CloudInstanceCurrentStateNetworkArgs>());
            set => _networks = value;
        }
        ...
        private InputList<Inputs.CloudInstanceCurrentStateSecurityGroupArgs>? _securityGroups;

        /// <summary>
        /// Security groups currently attached to the instance's ports:
        /// </summary>
        public InputList<Inputs.CloudInstanceCurrentStateSecurityGroupArgs> SecurityGroups
        {
            get => _securityGroups ?? (_securityGroups = new InputList<Inputs.CloudInstanceCurrentStateSecurityGroupArgs>());
            set => _securityGroups = value;
        }

        [Input("shares")]
        private InputList<Inputs.CloudInstanceCurrentStateShareArgs>? _shares;

        /// <summary>
        /// Filesystem shares attached to the instance. Each entry supports:
        /// </summary>
        public InputList<Inputs.CloudInstanceCurrentStateShareArgs> Shares
        {
            get => _shares ?? (_shares = new InputList<Inputs.CloudInstanceCurrentStateShareArgs>());
            set => _shares = value;
        }
        ...
        [Input("volumes")]
        private InputList<Inputs.CloudInstanceCurrentStateVolumeArgs>? _volumes;

        /// <summary>
        /// Observed block volumes attached to the instance:
        /// </summary>
        public InputList<Inputs.CloudInstanceCurrentStateVolumeArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.CloudInstanceCurrentStateVolumeArgs>());
            set => _volumes = value;
        }

        public CloudInstanceCurrentStateArgs()
        {
        }
        public static new CloudInstanceCurrentStateArgs Empty => new CloudInstanceCurrentStateArgs();
    }
}
