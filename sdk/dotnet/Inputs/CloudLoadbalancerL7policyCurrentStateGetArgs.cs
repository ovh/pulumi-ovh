...
namespace Pulumi.Ovh.Inputs
{
    ...
    public sealed class CloudLoadbalancerL7policyCurrentStateGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("rules")]
        private InputList<Inputs.CloudLoadbalancerL7policyCurrentStateRuleGetArgs>? _rules;

        /// <summary>
        /// List of L7 rules for this policy. All rules must match for the policy to apply:
        /// </summary>
        public InputList<Inputs.CloudLoadbalancerL7policyCurrentStateRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.CloudLoadbalancerL7policyCurrentStateRuleGetArgs>());
            set => _rules = value;
        }

        public CloudLoadbalancerL7policyCurrentStateGetArgs()
        {
        }
        public static new CloudLoadbalancerL7policyCurrentStateGetArgs Empty => new CloudLoadbalancerL7policyCurrentStateGetArgs();
    }
}
