...
namespace Pulumi.Ovh.Inputs
{
    ...
    public sealed class CloudKeyManagerSecretCurrentStateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("location")]
        public Input<Inputs.CloudKeyManagerSecretCurrentStateLocationArgs>? Location { get; set; }
        ...
        public CloudKeyManagerSecretCurrentStateArgs()
        {
        }
        public static new CloudKeyManagerSecretCurrentStateArgs Empty => new CloudKeyManagerSecretCurrentStateArgs();
    }
}
