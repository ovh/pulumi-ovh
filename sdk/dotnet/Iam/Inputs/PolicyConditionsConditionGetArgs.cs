...
namespace Pulumi.Ovh.Iam.Inputs
{
    ...
    public sealed class PolicyConditionsConditionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Inputs.PolicyConditionsConditionConditionGetArgs>? _conditions;

        /// <summary>
        /// A list of nested conditions. This is the recursive part.
        /// </summary>
        public InputList<Inputs.PolicyConditionsConditionConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.PolicyConditionsConditionConditionGetArgs>());
        ...
        public PolicyConditionsConditionGetArgs()
        {
        }
        public static new PolicyConditionsConditionGetArgs Empty => new PolicyConditionsConditionGetArgs();
    }
}
