...
namespace Pulumi.Ovh.CloudProject.Inputs
{
    ...
    public sealed class RancherTargetSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.RancherTargetSpecIpRestrictionArgs> IpRestrictions
        {
            get => _ipRestrictions ?? (_ipRestrictions = new InputList<Inputs.RancherTargetSpecIpRestrictionArgs>());
        ...
        public RancherTargetSpecArgs()
        {
        }
        public static new RancherTargetSpecArgs Empty => new RancherTargetSpecArgs();
    }
}
