...
namespace Pulumi.Ovh.CloudProject.Inputs
{
    ...
    public sealed class RegionNetworkSubnetGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("allocationPools")]
        private InputList<Inputs.RegionNetworkSubnetAllocationPoolGetArgs>? _allocationPools;

        /// <summary>
        /// List of IP pools allocated in subnet
        /// </summary>
        public InputList<Inputs.RegionNetworkSubnetAllocationPoolGetArgs> AllocationPools
        {
            get => _allocationPools ?? (_allocationPools = new InputList<Inputs.RegionNetworkSubnetAllocationPoolGetArgs>());
        ...
        [Input("hostRoutes")]
        private InputList<Inputs.RegionNetworkSubnetHostRouteGetArgs>? _hostRoutes;

        /// <summary>
        /// Host routes
        /// </summary>
        public InputList<Inputs.RegionNetworkSubnetHostRouteGetArgs> HostRoutes
        {
            get => _hostRoutes ?? (_hostRoutes = new InputList<Inputs.RegionNetworkSubnetHostRouteGetArgs>());
        ...
        public RegionNetworkSubnetGetArgs()
        {
        }
        public static new RegionNetworkSubnetGetArgs Empty => new RegionNetworkSubnetGetArgs();
    }
}
