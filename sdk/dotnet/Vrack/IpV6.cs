...
namespace Pulumi.Ovh.Vrack
{
    ...
    /// ```
    /// </summary>
    [OvhResourceType("ovh:Vrack/ipV6:IpV6")]
    public partial class IpV6 : global::Pulumi.CustomResource
    {
        ...
        public IpV6(string name, IpV6Args args, CustomResourceOptions? options = null)
            : base("ovh:Vrack/ipV6:IpV6", name, args ?? new IpV6Args(), MakeResourceOptions(options, ""))
        {
        }

        private IpV6(string name, Input<string> id, IpV6State? state = null, CustomResourceOptions? options = null)
            : base("ovh:Vrack/ipV6:IpV6", name, state, MakeResourceOptions(options, id))
        {
        }
