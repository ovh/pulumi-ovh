...
func (o LookupContainerRegistriesResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupContainerRegistriesResult] {
	return pulumix.Output[LookupContainerRegistriesResult]{
