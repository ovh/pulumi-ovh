...
type RegionStoragePresign struct {
	...
	SignedHeaders pulumi.StringMapOutput `pulumi:"signedHeaders"`
	// Computed URL result.
...
type regionStoragePresignState struct {
	...
	// Map of signed headers.
	SignedHeaders map[string]string `pulumi:"signedHeaders"`
	// Computed URL result.
...
type RegionStoragePresignState struct {
	...
	// Map of signed headers.
	SignedHeaders pulumi.StringMapInput
	// Computed URL result.
...
// Map of signed headers.
func (o RegionStoragePresignOutput) SignedHeaders() pulumi.StringMapOutput {
	return o.ApplyT(func(v *RegionStoragePresign) pulumi.StringMapOutput { return v.SignedHeaders }).(pulumi.StringMapOutput)
}
...
// Version ID of the object to download or delete
func (o RegionStoragePresignOutput) VersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RegionStoragePresign) pulumi.StringPtrOutput { return v.VersionId }).(pulumi.StringPtrOutput)
}
