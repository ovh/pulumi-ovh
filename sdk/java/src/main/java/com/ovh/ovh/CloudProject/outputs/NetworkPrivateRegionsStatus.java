...
@CustomType
public final class NetworkPrivateRegionsStatus {
    ...
    public static Builder builder(NetworkPrivateRegionsStatus defaults) {
    ...
    public static final class Builder {
        ...
        private String status;
        public Builder() {}
        public Builder(NetworkPrivateRegionsStatus defaults) {
