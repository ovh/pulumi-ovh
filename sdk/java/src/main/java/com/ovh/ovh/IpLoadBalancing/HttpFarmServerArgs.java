...
public final class HttpFarmServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final HttpFarmServerArgs Empty = new HttpFarmServerArgs();
    ...
    private HttpFarmServerArgs() {}

    private HttpFarmServerArgs(HttpFarmServerArgs $) {
    ...
    public static Builder builder(HttpFarmServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HttpFarmServerArgs();
        }

        public Builder(HttpFarmServerArgs defaults) {
            $ = new HttpFarmServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HttpFarmServerArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("HttpFarmServerArgs", "address");
            }
            if ($.farmId == null) {
                throw new MissingRequiredPropertyException("HttpFarmServerArgs", "farmId");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("HttpFarmServerArgs", "serviceName");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("HttpFarmServerArgs", "status");
            }
            return $;
        }
    }
