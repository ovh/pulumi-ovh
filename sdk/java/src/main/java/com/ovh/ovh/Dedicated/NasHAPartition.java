...
public class NasHAPartition extends com.pulumi.resources.CustomResource {
     ...
     */
    public NasHAPartition(String name) {
     ...
     */
    public static NasHAPartition get(String name, Output<String> id, @Nullable NasHAPartitionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
