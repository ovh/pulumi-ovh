...
public class UdpFrontend extends com.pulumi.resources.CustomResource {
     ...
     */
    public UdpFrontend(String name) {
     ...
     */
    public UdpFrontend(String name, UdpFrontendArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:IpLoadBalancing/udpFrontend:UdpFrontend", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private UdpFrontend(String name, Output<String> id, @Nullable UdpFrontendState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:IpLoadBalancing/udpFrontend:UdpFrontend", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static UdpFrontend get(String name, Output<String> id, @Nullable UdpFrontendState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
