...
public final class NasHAPartitionAccessArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(NasHAPartitionAccessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NasHAPartitionAccessArgs();
        }

        public Builder(NasHAPartitionAccessArgs defaults) {
            $ = new NasHAPartitionAccessArgs(Objects.requireNonNull(defaults));
        }
