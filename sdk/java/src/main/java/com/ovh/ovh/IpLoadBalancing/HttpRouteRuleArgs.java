...
public final class HttpRouteRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HttpRouteRuleArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("HttpRouteRuleArgs", "field");
            }
            if ($.match == null) {
                throw new MissingRequiredPropertyException("HttpRouteRuleArgs", "match");
            }
            if ($.routeId == null) {
                throw new MissingRequiredPropertyException("HttpRouteRuleArgs", "routeId");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("HttpRouteRuleArgs", "serviceName");
            }
            return $;
        }
    }
