...
public class TcpFrontend extends com.pulumi.resources.CustomResource {
     ...
     */
    public TcpFrontend(String name) {
     ...
     */
    public static TcpFrontend get(String name, Output<String> id, @Nullable TcpFrontendState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
