...
public class PermissionsGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public PermissionsGroup(String name, PermissionsGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:Iam/permissionsGroup:PermissionsGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private PermissionsGroup(String name, Output<String> id, @Nullable PermissionsGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:Iam/permissionsGroup:PermissionsGroup", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static PermissionsGroup get(String name, Output<String> id, @Nullable PermissionsGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
