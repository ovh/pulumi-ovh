...
public final class KubeCustomizationKubeProxyIptablesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private KubeCustomizationKubeProxyIptablesArgs() {}

    private KubeCustomizationKubeProxyIptablesArgs(KubeCustomizationKubeProxyIptablesArgs $) {
    ...
    public static Builder builder(KubeCustomizationKubeProxyIptablesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubeCustomizationKubeProxyIptablesArgs();
        }

        public Builder(KubeCustomizationKubeProxyIptablesArgs defaults) {
            $ = new KubeCustomizationKubeProxyIptablesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubeCustomizationKubeProxyIptablesArgs build() {
            return $;
        }
    }
