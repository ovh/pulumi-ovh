...
import com.ovhcloud.pulumi.ovh.outputs.StorageEfsPlanConfiguration;
...
@CustomType
public final class StorageEfsPlan {
    private @Nullable List<StorageEfsPlanConfiguration> configurations;
    /**
    ...
    private StorageEfsPlan() {}
    public List<StorageEfsPlanConfiguration> configurations() {
    ...
    public static Builder builder(StorageEfsPlan defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double quantity;
        public Builder() {}
        public Builder(StorageEfsPlan defaults) {
        ...
        @CustomType.Setter
        public Builder configurations(@Nullable List<StorageEfsPlanConfiguration> configurations) {

            this.configurations = configurations;
            return this;
        }
        public Builder configurations(StorageEfsPlanConfiguration... configurations) {
            return configurations(List.of(configurations));
        }
        @CustomType.Setter
        public Builder duration(String duration) {
            if (duration == null) {
              throw new MissingRequiredPropertyException("StorageEfsPlan", "duration");
            }
        ...
        public Builder planCode(String planCode) {
            if (planCode == null) {
              throw new MissingRequiredPropertyException("StorageEfsPlan", "planCode");
            }
        ...
        public Builder pricingMode(String pricingMode) {
            if (pricingMode == null) {
              throw new MissingRequiredPropertyException("StorageEfsPlan", "pricingMode");
            }
        ...
        public StorageEfsPlan build() {
            final var _resultValue = new StorageEfsPlan();
