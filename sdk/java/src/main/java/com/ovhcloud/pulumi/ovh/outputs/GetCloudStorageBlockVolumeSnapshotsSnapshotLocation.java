...
public final class GetCloudStorageBlockVolumeSnapshotsSnapshotLocation {
    ...
    public static Builder builder(GetCloudStorageBlockVolumeSnapshotsSnapshotLocation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetCloudStorageBlockVolumeSnapshotsSnapshotLocation", "region");
            }
            this.region = region;
            return this;
        }
