...
@CustomType
public final class NameTargetSpecDnsConfigurationNameServer {
    /**
    ...
    public static Builder builder(NameTargetSpecDnsConfigurationNameServer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String nameServer;
        public Builder() {}
        public Builder(NameTargetSpecDnsConfigurationNameServer defaults) {
        ...
        public NameTargetSpecDnsConfigurationNameServer build() {
            final var _resultValue = new NameTargetSpecDnsConfigurationNameServer();
