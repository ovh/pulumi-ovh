...
import com.ovhcloud.pulumi.ovh.Domain.inputs.NamePlanOptionConfigurationArgs;
...
public final class NamePlanOptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final NamePlanOptionArgs Empty = new NamePlanOptionArgs();

    @Import(name="configurations")
    private @Nullable Output<List<NamePlanOptionConfigurationArgs>> configurations;

    public Optional<Output<List<NamePlanOptionConfigurationArgs>>> configurations() {
    ...
    private NamePlanOptionArgs() {}

    private NamePlanOptionArgs(NamePlanOptionArgs $) {
    ...
    public static Builder builder(NamePlanOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NamePlanOptionArgs();
        }

        public Builder(NamePlanOptionArgs defaults) {
            $ = new NamePlanOptionArgs(Objects.requireNonNull(defaults));
        }

        public Builder configurations(@Nullable Output<List<NamePlanOptionConfigurationArgs>> configurations) {
            $.configurations = configurations;
            return this;
        }

        public Builder configurations(List<NamePlanOptionConfigurationArgs> configurations) {
            return configurations(Output.of(configurations));
        }

        public Builder configurations(NamePlanOptionConfigurationArgs... configurations) {
        ...
        public NamePlanOptionArgs build() {
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("NamePlanOptionArgs", "duration");
            }
            if ($.planCode == null) {
                throw new MissingRequiredPropertyException("NamePlanOptionArgs", "planCode");
            }
            if ($.pricingMode == null) {
                throw new MissingRequiredPropertyException("NamePlanOptionArgs", "pricingMode");
            }
            if ($.quantity == null) {
                throw new MissingRequiredPropertyException("NamePlanOptionArgs", "quantity");
            }
            return $;
        }
    }
