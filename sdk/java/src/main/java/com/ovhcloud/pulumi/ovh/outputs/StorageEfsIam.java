...
@CustomType
public final class StorageEfsIam {
    /**
    ...
    public static Builder builder(StorageEfsIam defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String urn;
        public Builder() {}
        public Builder(StorageEfsIam defaults) {
        ...
        public StorageEfsIam build() {
            final var _resultValue = new StorageEfsIam();
