...
public final class CloudProjectDatabaseFunctions {
     ...
     *             .build());
     * 
     *         ctx.export("capabilitiesEngineName", capabilities.applyValue(getCapabilitiesResult -> getCapabilitiesResult).stream().map(element -> element.engines()[0]).collect(toList()));
     *     }
     * }
     * }
     * </pre>
