 ...
 * import com.pulumi.ovh.IpLoadBalancing.VrackNetwork;
 * import com.pulumi.ovh.IpLoadBalancing.VrackNetworkArgs;
 ...
 *             .serviceName("xxx")
 *             .LoadbalancingId(iplb.applyValue(getIpLoadBalancingResult -> getIpLoadBalancingResult.serviceName()))
 *             .build());
 * 
 ...
 *             .zone(iplb.applyValue(getIpLoadBalancingResult -> getIpLoadBalancingResult.zones()[0]))
 *             .build());
 * 
 *     }
 * }
