...
import com.ovhcloud.pulumi.ovh.inputs.VrackservicesPlanConfigurationArgs;
...
public final class VrackservicesPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final VrackservicesPlanArgs Empty = new VrackservicesPlanArgs();

    @Import(name="configurations")
    private @Nullable Output<List<VrackservicesPlanConfigurationArgs>> configurations;

    public Optional<Output<List<VrackservicesPlanConfigurationArgs>>> configurations() {
    ...
    private VrackservicesPlanArgs() {}

    private VrackservicesPlanArgs(VrackservicesPlanArgs $) {
    ...
    public static Builder builder(VrackservicesPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VrackservicesPlanArgs();
        }

        public Builder(VrackservicesPlanArgs defaults) {
            $ = new VrackservicesPlanArgs(Objects.requireNonNull(defaults));
        }

        public Builder configurations(@Nullable Output<List<VrackservicesPlanConfigurationArgs>> configurations) {
            $.configurations = configurations;
            return this;
        }

        public Builder configurations(List<VrackservicesPlanConfigurationArgs> configurations) {
            return configurations(Output.of(configurations));
        }

        public Builder configurations(VrackservicesPlanConfigurationArgs... configurations) {
        ...
        public VrackservicesPlanArgs build() {
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("VrackservicesPlanArgs", "duration");
            }
            if ($.planCode == null) {
                throw new MissingRequiredPropertyException("VrackservicesPlanArgs", "planCode");
            }
            if ($.pricingMode == null) {
                throw new MissingRequiredPropertyException("VrackservicesPlanArgs", "pricingMode");
            }
            return $;
        }
    }
