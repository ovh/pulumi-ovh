...
public final class GetCertificatesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetCertificatesArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("GetCertificatesArgs", "clusterId");
            }
            if ($.engine == null) {
                throw new MissingRequiredPropertyException("GetCertificatesArgs", "engine");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetCertificatesArgs", "serviceName");
            }
            return $;
        }
    }
