...
public final class ServerUpdateState extends com.pulumi.resources.ResourceArgs {

    public static final ServerUpdateState Empty = new ServerUpdateState();
    ...
    public static Builder builder(ServerUpdateState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServerUpdateState();
        }

        public Builder(ServerUpdateState defaults) {
            $ = new ServerUpdateState(Objects.requireNonNull(defaults));
        }
        ...
        public ServerUpdateState build() {
            return $;
        }
    }
