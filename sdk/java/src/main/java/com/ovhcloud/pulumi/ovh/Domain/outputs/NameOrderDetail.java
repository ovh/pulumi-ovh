...
@CustomType
public final class NameOrderDetail {
    ...
    public static Builder builder(NameOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(NameOrderDetail defaults) {
        ...
        public NameOrderDetail build() {
            final var _resultValue = new NameOrderDetail();
