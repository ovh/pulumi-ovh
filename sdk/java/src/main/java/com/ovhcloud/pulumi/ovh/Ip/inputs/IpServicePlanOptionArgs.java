...
import com.ovhcloud.pulumi.ovh.Ip.inputs.IpServicePlanOptionConfigurationArgs;
...
public final class IpServicePlanOptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpServicePlanOptionArgs Empty = new IpServicePlanOptionArgs();
    ...
    private IpServicePlanOptionArgs() {}

    private IpServicePlanOptionArgs(IpServicePlanOptionArgs $) {
    ...
    public static Builder builder(IpServicePlanOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpServicePlanOptionArgs();
        }

        public Builder(IpServicePlanOptionArgs defaults) {
            $ = new IpServicePlanOptionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<IpServicePlanOptionConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<IpServicePlanOptionConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(IpServicePlanOptionConfigurationArgs... configurations) {
        ...
        public IpServicePlanOptionArgs build() {
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("IpServicePlanOptionArgs", "duration");
            }
            if ($.planCode == null) {
                throw new MissingRequiredPropertyException("IpServicePlanOptionArgs", "planCode");
            }
            if ($.pricingMode == null) {
                throw new MissingRequiredPropertyException("IpServicePlanOptionArgs", "pricingMode");
            }
            return $;
        }
    }
