...
@CustomType
public final class ServerOrderDetail {
    ...
    public static Builder builder(ServerOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(ServerOrderDetail defaults) {
        ...
        public ServerOrderDetail build() {
            final var _resultValue = new ServerOrderDetail();
