...
public final class PostgresSqlUserArgs extends com.pulumi.resources.ResourceArgs {

    public static final PostgresSqlUserArgs Empty = new PostgresSqlUserArgs();
    ...
    private PostgresSqlUserArgs() {}

    private PostgresSqlUserArgs(PostgresSqlUserArgs $) {
    ...
    public static Builder builder(PostgresSqlUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PostgresSqlUserArgs();
        }

        public Builder(PostgresSqlUserArgs defaults) {
            $ = new PostgresSqlUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param roles Roles the user belongs to. Available roles:
         * 
         * @return builder
         * 
         */
        ...
        public PostgresSqlUserArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("PostgresSqlUserArgs", "clusterId");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("PostgresSqlUserArgs", "serviceName");
            }
            return $;
        }
    }
