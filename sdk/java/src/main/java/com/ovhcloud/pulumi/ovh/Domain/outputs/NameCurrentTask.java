...
@CustomType
public final class NameCurrentTask {
    /**
    ...
    public static Builder builder(NameCurrentTask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(NameCurrentTask defaults) {
        ...
        public NameCurrentTask build() {
            final var _resultValue = new NameCurrentTask();
            _resultValue.id = id;
