...
@CustomType
public final class VrackservicesOrderDetail {
    ...
    private VrackservicesOrderDetail() {}
    ...
    public static Builder builder(VrackservicesOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(VrackservicesOrderDetail defaults) {
        ...
        public VrackservicesOrderDetail build() {
            final var _resultValue = new VrackservicesOrderDetail();
