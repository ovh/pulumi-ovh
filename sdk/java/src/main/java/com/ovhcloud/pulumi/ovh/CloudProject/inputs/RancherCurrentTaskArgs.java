...
public final class RancherCurrentTaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final RancherCurrentTaskArgs Empty = new RancherCurrentTaskArgs();
    ...
    private RancherCurrentTaskArgs() {}

    private RancherCurrentTaskArgs(RancherCurrentTaskArgs $) {
        this.id = $.id;
        this.link = $.link;
        this.status = $.status;
        this.type = $.type;
    ...
    public static Builder builder(RancherCurrentTaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RancherCurrentTaskArgs();
        }

        public Builder(RancherCurrentTaskArgs defaults) {
            $ = new RancherCurrentTaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RancherCurrentTaskArgs build() {
            return $;
        }
    }
