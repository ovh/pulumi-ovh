...
import com.ovhcloud.pulumi.ovh.CloudProjectDatabase.OpensearchUserArgs;
import com.ovhcloud.pulumi.ovh.CloudProjectDatabase.inputs.OpensearchUserState;
import com.ovhcloud.pulumi.ovh.CloudProjectDatabase.outputs.OpensearchUserAcl;
...
public class OpensearchUser extends com.pulumi.resources.CustomResource {
    ...
    public OpensearchUser(java.lang.String name, OpensearchUserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:CloudProjectDatabase/opensearchUser:OpensearchUser", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private OpensearchUser(java.lang.String name, Output<java.lang.String> id, @Nullable OpensearchUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ovh:CloudProjectDatabase/opensearchUser:OpensearchUser", name, state, makeResourceOptions(options, id), false);
    }
