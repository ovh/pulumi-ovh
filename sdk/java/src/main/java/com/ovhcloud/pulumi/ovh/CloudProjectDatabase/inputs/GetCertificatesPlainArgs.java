...
public final class GetCertificatesPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetCertificatesPlainArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("GetCertificatesPlainArgs", "clusterId");
            }
            if ($.engine == null) {
                throw new MissingRequiredPropertyException("GetCertificatesPlainArgs", "engine");
            }
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetCertificatesPlainArgs", "serviceName");
            }
            return $;
        }
    }
