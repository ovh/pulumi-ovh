...
import com.ovhcloud.pulumi.ovh.OVHcloud.outputs.ConnectsOccIam;
...
@CustomType
public final class ConnectsOcc {
    /**
    ...
    public static Builder builder(ConnectsOcc defaults) {
    ...
    public static final class Builder {
        ...
        private String vrack;
        public Builder() {}
        public Builder(ConnectsOcc defaults) {
        ...
        public Builder bandwidth(String bandwidth) {
            if (bandwidth == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "bandwidth");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "description");
            }
            this.description = description;
            return this;
        }
        @CustomType.Setter
        public Builder iam(ConnectsOccIam iam) {
            if (iam == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "iam");
            }
            this.iam = iam;
            return this;
        }
        ...
        public Builder interfaceLists(List<Double> interfaceLists) {
            if (interfaceLists == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "interfaceLists");
            }
        ...
        public Builder pop(String pop) {
            if (pop == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "pop");
            }
            this.pop = pop;
            return this;
        }
        ...
        public Builder portQuantity(String portQuantity) {
            if (portQuantity == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "portQuantity");
            }
        ...
        public Builder product(String product) {
            if (product == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "product");
            }
        ...
        public Builder providerName(String providerName) {
            if (providerName == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "providerName");
            }
        ...
        public Builder serviceName(String serviceName) {
            if (serviceName == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "serviceName");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        ...
        public Builder vrack(String vrack) {
            if (vrack == null) {
              throw new MissingRequiredPropertyException("ConnectsOcc", "vrack");
            }
            this.vrack = vrack;
            return this;
        }
        public ConnectsOcc build() {
            final var _resultValue = new ConnectsOcc();
