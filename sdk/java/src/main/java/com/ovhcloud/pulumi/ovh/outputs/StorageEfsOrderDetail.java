...
@CustomType
public final class StorageEfsOrderDetail {
    ...
    public static Builder builder(StorageEfsOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(StorageEfsOrderDetail defaults) {
        ...
        public StorageEfsOrderDetail build() {
            final var _resultValue = new StorageEfsOrderDetail();
