...
public final class GetCloudStorageBlockVolumeSnapshotLocation {
    ...
    public static Builder builder(GetCloudStorageBlockVolumeSnapshotLocation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetCloudStorageBlockVolumeSnapshotLocation", "region");
            }
            this.region = region;
            return this;
        }
