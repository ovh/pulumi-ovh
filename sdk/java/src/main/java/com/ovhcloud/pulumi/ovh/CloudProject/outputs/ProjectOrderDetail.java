...
@CustomType
public final class ProjectOrderDetail {
    /**
    ...
    public static Builder builder(ProjectOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(ProjectOrderDetail defaults) {
        ...
        public ProjectOrderDetail build() {
            final var _resultValue = new ProjectOrderDetail();
