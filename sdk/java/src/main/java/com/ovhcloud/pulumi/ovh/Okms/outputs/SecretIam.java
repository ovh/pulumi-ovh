...
public final class SecretIam {
    ...
    public static Builder builder(SecretIam defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String urn;
        public Builder() {}
        public Builder(SecretIam defaults) {
        ...
        public SecretIam build() {
            final var _resultValue = new SecretIam();
