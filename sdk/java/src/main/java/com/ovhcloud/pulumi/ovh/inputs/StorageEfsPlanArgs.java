...
import com.ovhcloud.pulumi.ovh.inputs.StorageEfsPlanConfigurationArgs;
...
public final class StorageEfsPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final StorageEfsPlanArgs Empty = new StorageEfsPlanArgs();

    @Import(name="configurations")
    private @Nullable Output<List<StorageEfsPlanConfigurationArgs>> configurations;

    public Optional<Output<List<StorageEfsPlanConfigurationArgs>>> configurations() {
    ...
    private StorageEfsPlanArgs() {}

    private StorageEfsPlanArgs(StorageEfsPlanArgs $) {
    ...
    public static Builder builder(StorageEfsPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StorageEfsPlanArgs();
        }

        public Builder(StorageEfsPlanArgs defaults) {
            $ = new StorageEfsPlanArgs(Objects.requireNonNull(defaults));
        }

        public Builder configurations(@Nullable Output<List<StorageEfsPlanConfigurationArgs>> configurations) {
            $.configurations = configurations;
            return this;
        }

        public Builder configurations(List<StorageEfsPlanConfigurationArgs> configurations) {
            return configurations(Output.of(configurations));
        }

        public Builder configurations(StorageEfsPlanConfigurationArgs... configurations) {
        ...
        public StorageEfsPlanArgs build() {
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("StorageEfsPlanArgs", "duration");
            }
            if ($.planCode == null) {
                throw new MissingRequiredPropertyException("StorageEfsPlanArgs", "planCode");
            }
            if ($.pricingMode == null) {
                throw new MissingRequiredPropertyException("StorageEfsPlanArgs", "pricingMode");
            }
            return $;
        }
    }
