...
public final class CloudProjectDatabaseClickhouseUserArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudProjectDatabaseClickhouseUserArgs Empty = new CloudProjectDatabaseClickhouseUserArgs();
    ...
    private CloudProjectDatabaseClickhouseUserArgs() {}

    private CloudProjectDatabaseClickhouseUserArgs(CloudProjectDatabaseClickhouseUserArgs $) {
    ...
    public static Builder builder(CloudProjectDatabaseClickhouseUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProjectDatabaseClickhouseUserArgs();
        }

        public Builder(CloudProjectDatabaseClickhouseUserArgs defaults) {
            $ = new CloudProjectDatabaseClickhouseUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudProjectDatabaseClickhouseUserArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("CloudProjectDatabaseClickhouseUserArgs", "clusterId");
            }
            return $;
        }
    }
