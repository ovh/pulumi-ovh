...
public final class GetLogsOutputGraylogStreamArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetLogsOutputGraylogStreamArgs build() {
            if ($.serviceName == null) {
                throw new MissingRequiredPropertyException("GetLogsOutputGraylogStreamArgs", "serviceName");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("GetLogsOutputGraylogStreamArgs", "title");
            }
            return $;
        }
    }
