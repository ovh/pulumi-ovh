...
import com.ovhcloud.ovh.Dedicated.inputs.ServerPlanConfigurationArgs;
...
public final class ServerPlanArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ServerPlanConfigurationArgs>> configurations;

    public Optional<Output<List<ServerPlanConfigurationArgs>>> configurations() {
    ...
    public static final class Builder {
        ...
        public Builder configurations(@Nullable Output<List<ServerPlanConfigurationArgs>> configurations) {
            $.configurations = configurations;
            return this;
        }

        public Builder configurations(List<ServerPlanConfigurationArgs> configurations) {
