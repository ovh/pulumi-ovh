...
import com.ovhcloud.ovh.Order.outputs.GetCartProductOptionsPlanPricePrice;
...
@CustomType
public final class GetCartProductOptionsPlanPrice {
    /**
     ...
     * 
     */
    private List<GetCartProductOptionsPlanPricePrice> prices;
    /**
    ...
    private GetCartProductOptionsPlanPrice() {}
    /**
     * @return Capacities of the pricing (type of pricing)
     * 
     */
     ...
     * 
     */
    public List<GetCartProductOptionsPlanPricePrice> prices() {
        return this.prices;
    }
    /**
     * @return Pricing model identifier
    ...
    public static Builder builder(GetCartProductOptionsPlanPrice defaults) {
    ...
    public static final class Builder {
        ...
        private String pricingType;
        public Builder() {}
        public Builder(GetCartProductOptionsPlanPrice defaults) {
        ...
        public Builder capacities(List<Object> capacities) {
            if (capacities == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "capacities");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "description");
            }
        ...
        public Builder duration(String duration) {
            if (duration == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "duration");
            }
        ...
        public Builder interval(Integer interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "interval");
            }
        ...
        public Builder maximumQuantity(Integer maximumQuantity) {
            if (maximumQuantity == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "maximumQuantity");
            }
        ...
        public Builder maximumRepeat(Integer maximumRepeat) {
            if (maximumRepeat == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "maximumRepeat");
            }
        ...
        public Builder minimumQuantity(Integer minimumQuantity) {
            if (minimumQuantity == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "minimumQuantity");
            }
        ...
        public Builder minimumRepeat(Integer minimumRepeat) {
            if (minimumRepeat == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "minimumRepeat");
            }
        ...
        public Builder priceInUcents(Integer priceInUcents) {
            if (priceInUcents == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "priceInUcents");
            }
            this.priceInUcents = priceInUcents;
            return this;
        }
        @CustomType.Setter
        public Builder prices(List<GetCartProductOptionsPlanPricePrice> prices) {
            if (prices == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "prices");
            }
            this.prices = prices;
            return this;
        }
        public Builder prices(GetCartProductOptionsPlanPricePrice... prices) {
            return prices(List.of(prices));
        }
        @CustomType.Setter
        public Builder pricingMode(String pricingMode) {
            if (pricingMode == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "pricingMode");
            }
        ...
        public Builder pricingType(String pricingType) {
            if (pricingType == null) {
              throw new MissingRequiredPropertyException("GetCartProductOptionsPlanPrice", "pricingType");
            }
            this.pricingType = pricingType;
            return this;
        }
        public GetCartProductOptionsPlanPrice build() {
            final var _resultValue = new GetCartProductOptionsPlanPrice();
