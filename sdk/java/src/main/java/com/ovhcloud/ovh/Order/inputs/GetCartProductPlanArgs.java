...
public final class GetCartProductPlanArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCartProductPlanArgs Empty = new GetCartProductPlanArgs();
    ...
    private GetCartProductPlanArgs() {}

    private GetCartProductPlanArgs(GetCartProductPlanArgs $) {
        this.cartId = $.cartId;
    ...
    public static Builder builder(GetCartProductPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCartProductPlanArgs();
        }

        public Builder(GetCartProductPlanArgs defaults) {
            $ = new GetCartProductPlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCartProductPlanArgs build() {
            if ($.cartId == null) {
                throw new MissingRequiredPropertyException("GetCartProductPlanArgs", "cartId");
            }
            if ($.planCode == null) {
                throw new MissingRequiredPropertyException("GetCartProductPlanArgs", "planCode");
            }
            if ($.priceCapacity == null) {
                throw new MissingRequiredPropertyException("GetCartProductPlanArgs", "priceCapacity");
            }
            if ($.product == null) {
                throw new MissingRequiredPropertyException("GetCartProductPlanArgs", "product");
            }
            return $;
        }
    }
