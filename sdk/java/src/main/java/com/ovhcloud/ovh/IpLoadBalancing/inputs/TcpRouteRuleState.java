...
public final class TcpRouteRuleState extends com.pulumi.resources.ResourceArgs {

    public static final TcpRouteRuleState Empty = new TcpRouteRuleState();
    ...
    private TcpRouteRuleState() {}

    private TcpRouteRuleState(TcpRouteRuleState $) {
    ...
    public static Builder builder(TcpRouteRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TcpRouteRuleState();
        }

        public Builder(TcpRouteRuleState defaults) {
            $ = new TcpRouteRuleState(Objects.requireNonNull(defaults));
        }
        ...
        public TcpRouteRuleState build() {
            return $;
        }
    }
