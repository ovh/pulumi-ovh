...
public final class ZoneOrderDetail {
    ...
    public static Builder builder(ZoneOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(ZoneOrderDetail defaults) {
        ...
        public ZoneOrderDetail build() {
            final var _resultValue = new ZoneOrderDetail();
