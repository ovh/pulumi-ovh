...
import com.ovhcloud.ovh.Order.outputs.GetCartProductResultPricePrice;
...
@CustomType
public final class GetCartProductResultPrice {
    /**
     ...
     * 
     */
    private List<GetCartProductResultPricePrice> prices;
    /**
    ...
    private GetCartProductResultPrice() {}
    /**
     * @return Capacities of the pricing (type of pricing)
     * 
     */
     ...
     * 
     */
    public List<GetCartProductResultPricePrice> prices() {
        return this.prices;
    }
    /**
     * @return Pricing model identifier
    ...
    public static Builder builder(GetCartProductResultPrice defaults) {
    ...
    public static final class Builder {
        ...
        private String pricingType;
        public Builder() {}
        public Builder(GetCartProductResultPrice defaults) {
        ...
        public Builder capacities(List<Object> capacities) {
            if (capacities == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "capacities");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "description");
            }
        ...
        public Builder duration(String duration) {
            if (duration == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "duration");
            }
        ...
        public Builder interval(Integer interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "interval");
            }
        ...
        public Builder maximumQuantity(Integer maximumQuantity) {
            if (maximumQuantity == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "maximumQuantity");
            }
        ...
        public Builder maximumRepeat(Integer maximumRepeat) {
            if (maximumRepeat == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "maximumRepeat");
            }
        ...
        public Builder minimumQuantity(Integer minimumQuantity) {
            if (minimumQuantity == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "minimumQuantity");
            }
        ...
        public Builder minimumRepeat(Integer minimumRepeat) {
            if (minimumRepeat == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "minimumRepeat");
            }
        ...
        public Builder priceInUcents(Integer priceInUcents) {
            if (priceInUcents == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "priceInUcents");
            }
            this.priceInUcents = priceInUcents;
            return this;
        }
        @CustomType.Setter
        public Builder prices(List<GetCartProductResultPricePrice> prices) {
            if (prices == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "prices");
            }
            this.prices = prices;
            return this;
        }
        public Builder prices(GetCartProductResultPricePrice... prices) {
            return prices(List.of(prices));
        }
        @CustomType.Setter
        public Builder pricingMode(String pricingMode) {
            if (pricingMode == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "pricingMode");
            }
        ...
        public Builder pricingType(String pricingType) {
            if (pricingType == null) {
              throw new MissingRequiredPropertyException("GetCartProductResultPrice", "pricingType");
            }
            this.pricingType = pricingType;
            return this;
        }
        public GetCartProductResultPrice build() {
            final var _resultValue = new GetCartProductResultPrice();
