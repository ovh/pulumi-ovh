...
public final class HttpFarmServerState extends com.pulumi.resources.ResourceArgs {

    public static final HttpFarmServerState Empty = new HttpFarmServerState();
    ...
    private HttpFarmServerState() {}

    private HttpFarmServerState(HttpFarmServerState $) {
    ...
    public static Builder builder(HttpFarmServerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HttpFarmServerState();
        }

        public Builder(HttpFarmServerState defaults) {
            $ = new HttpFarmServerState(Objects.requireNonNull(defaults));
        }
        ...
        public HttpFarmServerState build() {
            return $;
        }
    }
