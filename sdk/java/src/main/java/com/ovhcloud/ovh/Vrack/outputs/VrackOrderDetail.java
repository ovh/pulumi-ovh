...
@CustomType
public final class VrackOrderDetail {
    /**
    ...
    public static Builder builder(VrackOrderDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quantity;
        public Builder() {}
        public Builder(VrackOrderDetail defaults) {
        ...
        public VrackOrderDetail build() {
            final var _resultValue = new VrackOrderDetail();
